...
| 功能 ID | 功能名称 | 优先级 | 功能描述 |
|--------|---------|------|---------|
| F-033 | Node.js API 接口 | P1 | 提供易用的 Node.js API，便于集成到其他程序 |
...
| NF-006 | Node.js 版本兼容 | P0 | 支持 Node.js 14 及以上版本 |
...
- 使用 `markdown-it` / `marked` 作为 Markdown 解析基础
- 使用 `docx` (Node.js) 作为 Word 文档生成库
