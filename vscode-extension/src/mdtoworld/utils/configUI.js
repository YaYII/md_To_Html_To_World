...
const { COMPLETE_DEFAULTS } = require('./defaultConfig');
  ...
  async editFonts() {
    ...
    const answers = await inquirer.prompt([
      ...
      },
      {
        ...
        name: 'code',
        message: '代码字体:',
        default: fonts.code ?? COMPLETE_DEFAULTS.fonts.code
      },
      {
        type: 'input',
        name: 'headings',
    ...
    const answers = await inquirer.prompt([
      {
        ...
        name: 'default',
        message: '正文默认字号(磅):',
        default: sizes.default ?? COMPLETE_DEFAULTS.sizes.default
      },
      {
        type: 'number',
        name: 'code',
        message: '代码字号(磅):',
        default: sizes.code ?? COMPLETE_DEFAULTS.sizes.code
      },
      {
        type: 'number',
        name: 'heading1',
        message: '一级标题字号(磅):',
        default: sizes.heading1 ?? COMPLETE_DEFAULTS.sizes.heading1
      },
      {
        type: 'number',
        name: 'heading2',
        message: '二级标题字号(磅):',
        default: sizes.heading2 ?? COMPLETE_DEFAULTS.sizes.heading2
      },
      {
        type: 'number',
        name: 'heading3',
        message: '三级标题字号(磅):',
        default: sizes.heading3 ?? COMPLETE_DEFAULTS.sizes.heading3
      }
    ]);
    ...
    const answers = await inquirer.prompt([
      {
        ...
        name: 'default',
        message: '正文默认颜色(十六进制):',
        default: colors.default ?? COMPLETE_DEFAULTS.colors.default
      },
      {
        type: 'input',
        name: 'headings',
        message: '标题颜色(十六进制):',
        default: colors.headings ?? COMPLETE_DEFAULTS.colors.headings
      },
      {
        type: 'input',
        name: 'code',
        message: '代码颜色(十六进制):',
        default: colors.code ?? COMPLETE_DEFAULTS.colors.code
      },
      {
        type: 'input',
        name: 'link',
        message: '链接颜色(十六进制):',
        default: colors.link ?? COMPLETE_DEFAULTS.colors.link
      }
    ]);
    ...
    const answers = await inquirer.prompt([
      {
        ...
        name: 'line_spacing',
        message: '行间距倍数:',
        default: paragraph.line_spacing ?? COMPLETE_DEFAULTS.paragraph.line_spacing
      },
      {
        type: 'number',
        name: 'space_before',
        message: '段前间距(磅):',
        default: paragraph.space_before ?? COMPLETE_DEFAULTS.paragraph.space_before
      },
      {
        type: 'number',
        name: 'space_after',
        message: '段后间距(磅):',
        default: paragraph.space_after ?? COMPLETE_DEFAULTS.paragraph.space_after
      },
      {
        type: 'number',
        name: 'first_line_indent',
        message: '首行缩进字符数:',
        default: paragraph.first_line_indent ?? COMPLETE_DEFAULTS.paragraph.first_line_indent
      }
    ]);
    ...
    const answers = await inquirer.prompt([
      {
        ...
        name: 'even_row_color',
        message: '偶数行背景色(十六进制):',
        default: tableStyles.even_row_color ?? COMPLETE_DEFAULTS.table_styles.even_row_color
      },
      {
        type: 'input',
        name: 'odd_row_color',
      ...
      },
      {
        ...
        message: '表头背景色(十六进制):',
        default: tableStyles.header_bg_color ?? COMPLETE_DEFAULTS.table_styles.header_bg_color
      },
      {
        type: 'input',
        name: 'border_color',
    ...
    const answers = await inquirer.prompt([
      {
        ...
        name: 'page_size',
        message: '页面大小:',
        choices: ['A3', 'A4', 'Letter', 'Legal'],
        default: document.page_size ?? COMPLETE_DEFAULTS.document.page_size
      },
      {
        type: 'number',
        name: 'margin_top',
        message: '上边距(厘米):',
        default: document.margin_top ?? COMPLETE_DEFAULTS.document.margin_top
      },
      {
        type: 'number',
        name: 'margin_bottom',
        message: '下边距(厘米):',
        default: document.margin_bottom ?? COMPLETE_DEFAULTS.document.margin_bottom
      },
      {
        type: 'number',
        name: 'margin_left',
        message: '左边距(厘米):',
        default: document.margin_left ?? COMPLETE_DEFAULTS.document.margin_left
      },
      {
        type: 'number',
        name: 'margin_right',
        message: '右边距(厘米):',
        default: document.margin_right ?? COMPLETE_DEFAULTS.document.margin_right
      },
      {
        type: 'confirm',
        name: 'generate_toc',
        message: '是否生成目录:',
        default: document.generate_toc ?? COMPLETE_DEFAULTS.document.generate_toc
      }
    ]);
