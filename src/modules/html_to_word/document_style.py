...
class DocumentStyleManager:
    ...
    def __init__(self, config: Dict[str, Any]):
        ...
        # 段落格式配置
        self.paragraph_formats = self.config.get('paragraph_formats', {})
        self.line_spacing = self.paragraph_formats.get('line_spacing', 1.15)
        self.paragraph_spacing = self.paragraph_formats.get('paragraph_spacing', 8)
